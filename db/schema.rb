...
ActiveRecord::Schema.define(:version => 20121022091409) do
  ...
  create_table "gnodes", :force => true do |t|
    t.integer  "game_id"
    t.string   "name"
    t.text     "markup"
    t.datetime "created_at",          :null => false
  ...
  create_table "gpaths", :force => true do |t|
    t.integer  "gnode_id"
    t.string   "name"
    t.text     "markup"
    t.integer  "next_id"
  ...
  create_table "profile_parameters", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
